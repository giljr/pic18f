/* Project: Unit 06 - CCP
      Code: unit_06_01_capture.c

   Objective:   This is the Hello World for capture mode.
...
#endif
 TRISB =0;
 TRISC.RC2 = 1;                        // RC2 for input sygnal
 PORTC.RC2 = 1;
}
...
{                                      // ccp for capture
  CCP1CON = 0;                         // Microchip recommends: in each configuration, reset vector first!
